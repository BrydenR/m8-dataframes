...
husky.games.2015 <- read.csv("./info201/m8-dataframes/exercise-7/data/huskies_2015.csv")
...
MostYardsScore <- function (games) {
  ...
  return(paste("On ", date, " against ", opponent, " Huskies scored ", highest.score, "with ", rushing.yards, " yards rushed and ", passing.yards, " yards passed."))
}
...
husky.games.2016 = read.csv("./info201/m8-dataframes/exercise-7/data/huskies_2016.csv")
